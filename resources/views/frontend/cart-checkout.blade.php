                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="checkout__input">
                            ...
                            <input type="text" name="" placeholder="Street Address" class="checkout__input__add">
                            <input type="text" name="" placeholder="Apartment, suite, unite ect (optinal)">
                        </div>
                        <div class="checkout__input">
                        ...
                        <div class="checkout__input__checkbox">
                            <label for="acc">
                                Create an account?
                                <input type="checkbox" id="acc" value="" name="">
                        ...
                        <div class="checkout__input__checkbox">
                            <label for="diff-acc">
                                ...
                                <input type="checkbox" id="diff-acc" name="" value="">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="checkout__input">
